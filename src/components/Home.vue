      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            <h2 class="display-7 text-dark text-uppercase">Auction Products</h2>
            <div class="btn-right">
              <a href="shop.html" class="btn btn-medium btn-normal text-uppercase">see all products</a>
            </div>
          </div>
          <div class="swiper product-swiper">
            <div class="row">
              <div class="col-sm-3" v-for="ac in auctions" :key="ac.id">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img :src="ac.image" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <router-link :to="'/bid/'+ac.id" class="btn btn-medium btn-black">Bid Now<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></router-link>
                    </div>
                  </div>
                  <div class="card-detail  align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="#">{{ ac.title }}</a>
                    </h3>
                    <span class="item-price text-primary">Start Price: BDT{{ ac.starting_price }}</span>
                  </div>
                </div>
              </div>
